// ****************************************************
// pop.js
// Original by Eoin McGrath
// ****************************************************

// ****************************************************
// Namespace for our Pop Game
// ****************************************************
var POP = {
...
// ****************************************************************
// POP Game Objects and Constructors
// ****************************************************************

// ****************************************************************
// Draw Object (unique)
// Group canvas operations into standalone functions
// ****************************************************************
POP.Draw = {};  

POP.Draw.clear = function() {
  POP.ctx.clearRect(0, 0, POP.WIDTH, POP.HEIGHT);
};

POP.Draw.rect = function(x, y, w, h, col) {
  POP.ctx.fillStyle = col;
  POP.ctx.fillRect(x, y, w, h);
};

POP.Draw.circle = function(x, y, r, col) {
  POP.ctx.fillStyle = col;
  POP.ctx.beginPath();
...
POP.Draw.text = function(string, x, y, size, col) {
...
POP.Bubble = function() {
    ...
    // need to remember the original x position for our sine wave calculation
...
POP.Particle = function(x, y,r, col) {
  ...
  this.update = function() {
    ...
    // adding this negative amount to the y velocity exerts an upward
    // pull on the particle, as if drawn to the surface
    this.vy -= 0.25;
...
// POP Game Functions
// ****************************************************************
POP.addEventListeners = function() {
    // listen for clicks
    ...
    window.addEventListener('touchstart',
        function(e) {
            ...
            // the event object has an array called touches, we just want
            // the first touch
...
POP.init = function() {
  ...
  // it's important to set this otherwise the browser will
  // default to 320x200
  ...
  // we need to sniff out android & ios so we can hide the address bar in
  // our resize function
...
POP.resize = function() {
  ...
  // this will create some extra space on the page, allowing us
  // to scroll pass the address bar, and thus hide it.
  ...
  // we use a timeout here as some mobile browsers won't
  // scroll if there is not a small delay
...
POP.update = function() {
    ...
    for (i = 0; i < POP.entities.length; i += 1) {
        ...
        if (POP.entities[i].type === 'bubble' && checkCollision) {
            var hit = POP.collides(POP.entities[i],
    ...
    // update wave offset - feel free to play with these values for
...
POP.render = function() {
  ...
  POP.Draw.rect(0, 0, POP.WIDTH, POP.HEIGHT, POP.background);
  ...
  POP.Draw.text('Accuracy: ' + POP.score.accuracy + '%',
                20, 70, 14, '#fff');
};
...
POP.loop = function() {
  // the actual loop
  // requests animation frame then proceeds to update and render
